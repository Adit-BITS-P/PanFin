...
export default function About(){
    return(
        <div className="overlap-27">
          <div className="about">
           <div className="hit">
            <div id="about" className="text-wrapper-39">About</div>
          <img
            class="vector-2"
            src="https://c.animaapp.com/VFQnVRMH/img/vector-32.svg"
          />
          <div className="text-wrapper-40">Panchakshar<br/> Corp.</div>
          </div> 
...
In addition to serving domestic markets, we also export our products to international clients, adhering to global standards of quality and compliance. Our dedicated sales team, led by Kritika Sachan, ensures personalized support and seamless service for every client.
                ...
                <div className="overlap-group-9">
                  <div className="text-wrapper-41">Read more</div>
                </div>
                </a>
              </div>
              </div>
